              ...
              {collectionCategories.map((category) => (
                <li key={category.label} className="relative group">
                  {category.url ? (
                    <Link
                      href={category.url}
                      className="text-gray-800 hover:text-[#7c3f61] transition-colors"
                    >
                      {category.label}
                    </Link>
                  ) : (
                    <div className="relative">
                      ...
                      {category.subcategories && (
                        <div className="hidden group-hover:block absolute left-0 top-full w-48 bg-white shadow-lg rounded-md border border-[#7c3f61]/20 z-50">
                          <ul className="py-2">
                    ...
                    {category.url ? (
                      ...
                      <>
                        ...
                        {category.subcategories && openCategory === category.label && (
                          <ul className="ml-4 mt-1 space-y-2 border-l-2 border-[#7c3f61]/20 pl-4">
                            {category.subcategories.map((subcategory) => (
                              <li key={subcategory.name}>
                                <Link
                                  href={`/collections?category=${subcategory.query}`}
