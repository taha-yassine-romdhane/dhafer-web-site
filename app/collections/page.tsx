          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between mt-4 border-t pt-4">
              <div className="flex items-center gap-4">
                ...
                >
                  <SelectTrigger className="w-[200px] bg-white border border-gray-200 hover:border-[#7c3f61] transition-colors">
                ...
                {(filters.category !== "all") && (
                  <Button
                    ...
                    className="border border-gray-200 hover:border-[#7c3f61] hover:bg-[#7c3f61]/10 text-gray-600 hover:text-[#7c3f61] transition-colors"
                  >
                    Effacer les filtres
                  </Button>
                )}
