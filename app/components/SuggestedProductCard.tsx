              ...
              <div>
                {product.salePrice ? (
                  <div className="flex flex-col">
                    ...
                    <span className="text-xs font-bold text-[#D4AF37]">{formatPrice(product.salePrice)}</span>
                  </div>
                ) : (
                  <span className="text-xs font-bold text-[#D4AF37]">{formatPrice(product.price)}</span>
                )}
              </div>
              {product.salePrice && (
                <span className="text-xs bg-red-500 px-1.5 py-0.5 rounded">Promo</span>
              )}
            </div>
          </div>
        </div>
