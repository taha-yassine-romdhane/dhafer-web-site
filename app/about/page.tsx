            ...
            <motion.section className="mb-16" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
                ...
                <div className="grid md:grid-cols-2 gap-8 items-center">
                    <div>
                        ...
                        <button className="bg-[#7c3f61] text-white py-2 px-6 rounded-lg font-medium hover:bg-[#C49B2F] transition">
                            ...
                            <CardContent>
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center">
                                        <Phone className="mr-2 h-5 w-5 text-[#7c3f61]" />
                                        <p>{location.phone}</p>
                                    </div>
                                    <div className="flex items-center">
                                        <Mail className="mr-2 h-5 w-5 text-[#7c3f61]" />
                                        <p>{location.email}</p>
                                    </div>
                                    <div className="flex items-center">
                                        <Clock className="mr-2 h-5 w-5 text-[#7c3f61]" />
                                        <p>{location.hours}</p>
                                    </div>
